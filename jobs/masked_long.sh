#!/bin/bash
#SBATCH --job-name=cclb-masked
#SBATCH --output=/nfs/stak/users/hodgesf/results/masked_long_%j.log
#SBATCH --error=/nfs/stak/users/hodgesf/results/masked_long_%j.err
