#!/bin/bash
#SBATCH --job-name=cclb-baseline
#SBATCH --output=/nfs/stak/users/hodgesf/results/baseline_long_%j.log
#SBATCH --error=/nfs/stak/users/hodgesf/results/baseline_long_%j.err
