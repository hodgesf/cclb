#!/bin/bash
#SBATCH --job-name=cclb-1e8-10
#SBATCH --output=/nfs/stak/users/hodgesf/results/masked_1e8_10ep_%j.log
#SBATCH --error=/nfs/stak/users/hodgesf/results/masked_1e8_10ep_%j.err
